...
time = list(range(20200201, 20200230))
if not os.path.exists('D:\\2 研一\\课题组\\2019nCov\\pop_trans_data\\Baiduqianxi\\migra_proportion_top100\\move_out_city_proportion_top100\\Feb_2020'):
     os.mkdir('D:\\2 研一\\课题组\\2019nCov\\pop_trans_data\\Baiduqianxi\\migra_proportion_top100\\move_out_city_proportion_top100\\Feb_2020')
os.chdir('D:\\2 研一\\课题组\\2019nCov\\pop_trans_data\\Baiduqianxi\\migra_proportion_top100\\move_out_city_proportion_top100\\Feb_2020')
exist = os.listdir()
...
def main():
    for num, name in code.items():
        ...
        for t in time:
            try:
                print(name, t)
                utl = 'http://huiyan.baidu.com/migration/cityrank.jsonp?dt=province&id=' + num + '&type=move_out&date=' + str(t)
