...
time = list(range(20200101, 20200312)) #好像不用改，自动跑全部
if not os.path.exists('D:\\2 研一\\课题组\\2019nCov\\pop_trans_data\\Baiduqianxi\\migra_index'):
     os.mkdir('D:\\2 研一\\课题组\\2019nCov\\pop_trans_data\\Baiduqianxi\\migra_index')
os.chdir('D:\\2 研一\\课题组\\2019nCov\\pop_trans_data\\Baiduqianxi\\migra_index')
...
def main():
    for num, name in code.items():
        ...
        try:
            print(name)
            utl = 'http://huiyan.baidu.com/migration/historycurve.jsonp?dt=province&id=' + num + '&type=move_in&startDate=20200101&endDate=20200229'
